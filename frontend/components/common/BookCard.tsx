...
const BookCard: React.FC<BookCardProps> = ({ id, imageUrl, title, author }) => {
  return (
    ...
    <Link href={`/books/${id}`} className="text-center group">
      <div className="bg-gray-100 rounded-lg mb-4 p-3 flex items-center justify-center aspect-[3/4] cursor-pointer group-hover:shadow-xl transition-shadow">
